...
<img src = "https://user-images.githubusercontent.com/61929745/115385824-8a1a7480-a213-11eb-9225-3fc853d3c80a.png" width = 600 height = 400>
...
## 4. Mode Switching
* 이전 글에서 공부했던 것처럼, User-Kernel Mode Switching은 세 가지 상황에서 일어난다.
```
...
```
* Mode Switching은 OS가 Dual mode를 기반으로 하고 있으며, Interrupt를 통해 User가 Kernel 모드로 접근할 수 있도록 한다고 했다. Process Switching과는 별개의 내용이다.  
* Mode Switching의 과정을 순서로 살펴보면 아래와 같다.
```
1. 현재 프로세서의 상태를 저장한다.
